...
class DatasetConfig(FairseqDataclass):
    ...
    competence_step: int = field(
        default=1, metadata={ "help": "training step for competence, should less than total_number_update"}
    )
    span_length: int = field(
            default=1, metadata={"help":"-1:token level 0:word level 1:span"}
    )
