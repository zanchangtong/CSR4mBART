...
class EpochBatchIterator(EpochBatchIterating):
    ...
    def first_batch(self):
        ...
        if getattr(self.dataset, "supports_fetch_outside_dataloader", True):  # mbart
    ...
    def _get_iterator_for_epoch(
        ...
        # mbart: batches - list, len - 8247, 每个元素都是8位列表。[193213, 325433, 288926, 154393, 77373, 608512, 213369, 239654]
        # Create data loader
        # if self.get_step: 
...
class ShardedIterator(CountingIterator):
    ...
    def __init__(self, iterable, num_shards, shard_id, fill_value=None):
        ...
        #  operator.itemgetter: Return a callable object that fetches item from its operand using the operand’s __getitem__() method
        itr = map(
