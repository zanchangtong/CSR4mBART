...
class MbartSentencePredictionTask(LegacyFairseqTask):
    ...
    @classmethod
    def load_dictionary(cls, args, filename, source=True, with_lid=False):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        src_tokens = maybe_shorten_dataset(
            ...
            self.args.seed,
        ) # edit max_positions to max_source_positions
        # fix
        src_tokens = PrependTokenDataset(src_tokens, self.dictionary.index('[{}]'.format(self.args.source_lang)))
